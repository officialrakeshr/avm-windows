...
```powershell
Set-ExecutionPolicy RemoteSigned -Scope CurrentUser -Force; iwr -useb https://raw.githubusercontent.com/officialrakeshr/angular-version-manager-windows/main/install_avm.ps1 | iex
